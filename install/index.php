            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <p class="subheader d-flex flex-row">
                    <span class="text-muted">
                        <a href="<?= PRODUCT_URL ?>" target="_blank" class="text-gray-500"><?= PRODUCT_NAME ?></a> by <a href="https://if.iti.ac.id" target="_blank" class="text-gray-500">IF ITI</a>
                    </span>
                </p>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <section id="welcome" style="display: none">
                            ...
                            <p>Pada Tahap Ini kita akan melakukan instalasi web terlebih dahulu.</p>
